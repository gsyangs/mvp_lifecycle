...
public class ToastUtil {
    ...
    public static void showShortToast(String msg) {
        showCustomToast(JetpApplication.getInstance(), msg, Toast.LENGTH_SHORT);
    }

    public static void showShortToast(int msgId) {
        showCustomToast(JetpApplication.getInstance(), msgId, Toast.LENGTH_SHORT);
    }

    public static void showLongToast(String msg) {
        showCustomToast(JetpApplication.getInstance(), msg, Toast.LENGTH_LONG);
    }

    public static void showLongToast(int msgId) {
        showCustomToast(JetpApplication.getInstance(), msgId, Toast.LENGTH_LONG);
    }
